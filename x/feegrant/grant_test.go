...
func TestGrant(t *testing.T) {
	...
	addr, err := sdk.AccAddressFromBech32("0x058B15d64f210480217Ab50093b7373a41a86c33")
	require.NoError(t, err)
	addr2, err := sdk.AccAddressFromBech32("0x09417AFda96Ea6f066FC943bfaDBc87e63Eb67E5")
	require.NoError(t, err)
