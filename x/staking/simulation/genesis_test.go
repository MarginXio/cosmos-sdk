...
func TestRandomizedGenState(t *testing.T) {
	...
	// check Delegations
	require.Equal(t, "0x5cEEa0528c3b88442d6580c548753DD89b99a213", stakingGenesis.Delegations[0].DelegatorAddress)
	require.Equal(t, "0x5cEEa0528c3b88442d6580c548753DD89b99a213", stakingGenesis.Delegations[0].ValidatorAddress)
	require.Equal(t, "1000.000000", stakingGenesis.Delegations[0].Shares.String())
	// check validators
	require.Equal(t, "0x45f3624b98fCfc4D7A6b37B0957b656878636773", stakingGenesis.Validators[2].GetOperator().String())
	...
	require.Equal(t, "1000.000000", stakingGenesis.Validators[2].DelegatorShares.String())
	require.Equal(t, "0.500945", stakingGenesis.Validators[2].Commission.CommissionRates.Rate.String())
	require.Equal(t, "0.750000", stakingGenesis.Validators[2].Commission.CommissionRates.MaxRate.String())
	require.Equal(t, "0.170480", stakingGenesis.Validators[2].Commission.CommissionRates.MaxChangeRate.String())
