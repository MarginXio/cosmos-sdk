...
func (m *FeeSpendProposal) Reset()      { *m = FeeSpendProposal{} }
func (*FeeSpendProposal) ProtoMessage() {}
func (*FeeSpendProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_cd78a31ea281a992, []int{9}
}
func (m *FeeSpendProposal) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *FeeSpendProposal) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_FeeSpendProposal.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *FeeSpendProposal) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FeeSpendProposal.Merge(m, src)
}
func (m *FeeSpendProposal) XXX_Size() int {
	return m.Size()
}
func (m *FeeSpendProposal) XXX_DiscardUnknown() {
	xxx_messageInfo_FeeSpendProposal.DiscardUnknown(m)
}

var xxx_messageInfo_FeeSpendProposal proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*FeeSpendProposal)(nil), "cosmos.distribution.v1beta1.FeeSpendProposal")
...
var fileDescriptor_cd78a31ea281a992 = []byte{
	...
	,
}
...
func (m *FeeSpendProposal) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *FeeSpendProposal) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *FeeSpendProposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *FeeSpendProposal) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *FeeSpendProposal) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FeeSpendProposal: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FeeSpendProposal: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
